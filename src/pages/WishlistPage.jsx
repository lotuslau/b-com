...
export default function WishlistPage({
  ...
  const totalValue = wishlistProducts.reduce(
    (sum, p) => sum + parseFloat(p.price_bzd || p.price || 0),
    0
  );
    ...
    <div style={{ padding: "2rem" }}>
      ...
      {wishlistProducts.length === 0 ? (
        ...
        >
          ...
          >
            Browse our collection and click ♡ Save to Wishlist on
            products you love
          </p>
                ...
                onClick={() => {
                  wishlistProducts.forEach((p) => {
                    addToCart(
                      p,
                      p.sizes
                        ? JSON.parse(p.sizes)[0]
                        : "One Size",
                      p.colors
                        ? JSON.parse(p.colors)[0]
                        : "Default"
                    );
                  });
                }}
